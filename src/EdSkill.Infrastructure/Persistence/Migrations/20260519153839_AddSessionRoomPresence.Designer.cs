...
namespace EdSkill.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260519153839_AddSessionRoomPresence")]
    partial class AddSessionRoomPresence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EdSkill.Domain.Entities.SessionPresenceSegment", b =>
                {
                    b.Property<Guid>("SessionPresenceSegmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("SessionPresenceSegmentId");
                    ...
                    b.HasIndex("SessionId", "UserId", "JoinedAt");

                    b.ToTable("SessionPresenceSegments");
                });
            ...
            modelBuilder.Entity("EdSkill.Domain.Entities.SystemConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Key = "session.join_early_minutes",
                            Description = "So phut duoc vao phong truoc gio hoc.",
                            UpdatedAt = new DateTime(2026, 5, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            Value = "10"
                        },
                        new
                        {
                            Key = "session.join_late_grace_minutes",
                            Description = "So phut cho phep vao phong sau gio ket thuc du kien.",
                            UpdatedAt = new DateTime(2026, 5, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            Value = "30"
                        });
                });
            ...
            modelBuilder.Entity("EdSkill.Domain.Entities.SessionPresenceSegment", b =>
                {
                    b.HasOne("EdSkill.Domain.Entities.Session", "Session")
                        .WithMany("PresenceSegments")
                        .HasForeignKey("SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EdSkill.Domain.Entities.User", "User")
                        .WithMany("SessionPresenceSegments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("EdSkill.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("SessionPresenceSegments");

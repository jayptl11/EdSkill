...
public class ProcessSubscriptionVnPayIpnCallbackCommandHandler : IRequestHandler<ProcessSubscriptionVnPayIpnCallbackCommand, Result<VnPayIpnResponseDto>>
{
    private readonly IWalletPaymentProcessingService _walletPaymentProcessingService;

    public ProcessSubscriptionVnPayIpnCallbackCommandHandler(IWalletPaymentProcessingService walletPaymentProcessingService)
    {
        _walletPaymentProcessingService = walletPaymentProcessingService;
    }

    public async Task<Result<VnPayIpnResponseDto>> Handle(ProcessSubscriptionVnPayIpnCallbackCommand request, CancellationToken cancellationToken)
    {

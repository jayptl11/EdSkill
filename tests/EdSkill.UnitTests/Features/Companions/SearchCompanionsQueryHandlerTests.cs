...
public class SearchCompanionsQueryHandlerTests
{
    ...
    public async Task Handle_WhenOfflineSearchMatchesAvailableSession_ReturnsPublicCompanionsWithRating()
    {
        ...
        var handler = new SearchCompanionsQueryHandler(contextMock.Object, currentUserServiceMock.Object, sessionPricingServiceMock.Object);
        ...
        result.Value.Data.Single().PricingPreview.MinLearnerChargePoints.Should().Be(100);
    }
}
